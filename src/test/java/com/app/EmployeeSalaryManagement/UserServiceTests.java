...
class UserServiceTests {
    ...
    void getAllUsersTest() {
        ...
        Integer offset = 0;
        Integer limit = 1;
        when(userRepository.findUserBySalaryBetweenOrderByIdAsc(minSalary, maxSalary)).thenReturn(Stream.of(new User("e0001", "hpotter", "Harry Potter", 1234.00, LocalDate.parse("2001-11-19"))).collect(Collectors.toList()));
        assertEquals(200, userService.getAllUsers(minSalary, maxSalary, offset, limit).getStatus());
    }
